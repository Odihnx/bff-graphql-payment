...
ARG HOST_API_INFRASTRUCTURE
ARG PORT_API_INFRASTRUCTURE
ARG USE_MOCK=false
...
ENV HOST_API_INFRASTRUCTURE=${HOST_API_INFRASTRUCTURE}
ENV PORT_API_INFRASTRUCTURE=${PORT_API_INFRASTRUCTURE}
